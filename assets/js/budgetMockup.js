...
let sales = [12270, 18249, 17095, 16671, 17914, 17448, 16931, 12708, 14447, 17242, 10499, 11886];
let budget = [15280, 15280, 15280, 15280, 15280, 15280, 15280, 15280, 15280, 15280, 15280, 15280];

let diffActualBudget = calcDiff(sales, budget);
let normSales = calcRMS(sales);
let stdSales = calcStd(sales);
